...
const config: HardhatUserConfig = {
    ...
    networks: {
        ...
        'xlayer-testnet': {
            ...
            url: process.env.RPC_URL_XLAYER_TESTNET || 'https://testrpc.xlayer.tech',
            accounts,
        },
        'worldchain-testnet': {
            eid: EndpointId.WORLDCOIN_V2_TESTNET,
            url: process.env.RPC_URL_WORLDCHAIN_TESTNET || 'https://worldchain-sepolia.gateway.tenderly.co',
            accounts,
        },
        // ── Mainnets ──────────────────────────────────────────
        'bsc': {
