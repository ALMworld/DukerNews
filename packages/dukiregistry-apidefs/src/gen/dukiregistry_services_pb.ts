...
export const file_dukiregistry_services: GenFile = /*@__PURE__*/
  fileDesc("", [file_duker_registry, file_dukigen_registry]);
 ...
 * the page already ordered by reputation desc for the requested timescale.
 * Cursor is opaque (server-encoded compound key over reputation + agent_id)
...
export type RankedAgent = Message<"dukiregistry.RankedAgent"> & {
  ...
  /**
   * @generated from field: uint64 reputation = 2;
   */
  reputation: bigint;
};
